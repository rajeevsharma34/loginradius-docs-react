...
Refer to [Advanced Customization](https://www.loginradius.com/docs/api/v2/user-registration/advanced-customization#standardandphonelogin18) and [Phone Login Configuration](https://www.loginradius.com/docs/authentication/tutorial/phone-login/) documents to configure this workflow.
